...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/kimaiy0/Info-Bot)
...
**1.** Clone the Repo
```
git clone https://github.com/kimaiy0/Info-Bot
```
